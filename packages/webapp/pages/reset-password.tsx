      ...
      <div className="flex min-h-screen w-full flex-col items-center px-4 py-10">
        ...
        <div className="mt-10 flex max-w-[30rem] flex-col items-center">
          <AuthModalText className="text-center">
            {error === 'INVALID_TOKEN'
              ? 'Bu şifre sıfırlama bağlantısının süresi dolmuş veya geçersiz. Lütfen yeni bir bağlantı talep edin.'
              : 'Geçersiz şifre sıfırlama bağlantısı. Lütfen yeni bir bağlantı talep edin.'}
          </AuthModalText>
          <Button
            className="mt-6"
