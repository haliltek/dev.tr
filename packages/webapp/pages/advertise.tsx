...
const AdvertisePage = (): ReactElement => {
      ...
      <div id="formats" className="mt-16">
        <div className="text-center max-w-2xl mx-auto">
          ...
          <p className="mt-3 text-text-secondary text-sm laptop:text-base">
            Geleneksel, rahatsız edici banner reklamlar yerine geliştiricilerin doğal içerik olarak tükettiği modern yerleşimler sunuyoruz.
          </p>
        </div>
...
AdvertisePage.getLayout = getLayout;
AdvertisePage.layoutProps = {
