...
export default function UserDropdown() {
  ...
  return (
    <div className="relative">
      ...
      >
        <span className="me-3 flex h-10 w-10 items-center justify-center rounded-full bg-blue-600/20 text-blue-600 font-bold text-sm">
          AD
        </span>
      ...
      >
        <div>
          <span className="block text-theme-sm font-semibold text-gray-800 dark:text-white">
            devcore.tr Admin
          </span>
        ...
        <button
          ...
          className="group mt-3 flex items-center justify-center gap-2 rounded-lg border border-red-200 px-3 py-2 text-theme-sm font-medium text-red-600 hover:bg-red-50 dark:border-red-900/50 dark:text-red-400 dark:hover:bg-red-950/30 w-full"
        >
          Güvenli Çıkış Yap
        </button>
      </Dropdown>
