...
export const leaderboardTypeToTitle: Record<LeaderboardType, string> = {
  [LeaderboardType.HighestReputation]: 'En yüksek itibar',
  [LeaderboardType.LongestStreak]: 'En uzun seri',
  [LeaderboardType.HighestPostViews]: 'En çok görüntülenenler',
  [LeaderboardType.MostUpvoted]: 'En çok upvote alanlar',
  [LeaderboardType.MostReferrals]: 'En çok davet edenler',
  [LeaderboardType.MostReadingDays]: 'En çok okuma günü',
  [LeaderboardType.MostVerifiedUsers]: 'En çok onaylı çalışan',
  [LeaderboardType.MostQuestsCompleted]: 'En çok görev tamamlayan',
  [LeaderboardType.HighestLevel]: 'En yüksek seviye',
};
