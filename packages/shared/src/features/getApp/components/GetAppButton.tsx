...
export function GetAppButton({
  ...
  return (
    <Popover open={isOpen} onOpenChange={onOpenChange}>
      <Tooltip content="Mobil uygulamayı edinin" side="bottom" visible={!showLabel}>
        <PopoverTrigger asChild>
          <Button
            ...
            aria-label="devcore.tr mobil uygulamasını edinin"
          >
            {showLabel ? 'Uygulamayı İndir' : null}
          </Button>
        </PopoverTrigger>
      </Tooltip>
      <PopoverContent
        ...
        <div className="flex gap-4">
          ...
          <div className="flex min-w-0 flex-1 flex-col justify-center gap-1">
            <p className="font-bold text-text-primary typo-callout">
              devcore.tr cebinizde
            </p>
            <p className="text-text-tertiary typo-footnote">
              Kameranızla QR kodu tarayın. Akışınız, kayıtlarınız ve seriniz daima yanınızda olsun.
            </p>
          </div>
        </div>
