...
export const HOT_TAKE_LIMIT_HINT = `En fazla ${MAX_HOT_TAKES} hot take ekleyebilirsiniz`;
export const HOT_TAKE_LIMIT_REACHED_MESSAGE = `Zaten ${MAX_HOT_TAKES} hot take eklediniz. Yeni eklemek için birini kaldırın.`;
