...
const SidebarInviteButton = (): ReactElement => (
  <Tooltip side="right" content="Arkadaşlarını Davet Et">
    <Link href={`${settingsUrl}/invite`} passHref>
      <a aria-label="Arkadaşlarını Davet Et" className={railButtonClass}>
...
const supportItems: ProfileSectionItemProps[] = [
  ...
  { title: 'Dokümantasyon', href: docs, icon: DocsIcon, external: true },
  { title: 'Hata bildir', href: feedback, icon: FlagIcon, external: true },
];
...
const SidebarSupportButton = ({
  ...
  return (
    <>
      <Tooltip side="right" content="Destek">
        <button
          type="button"
          aria-label="Destek"
...
const SidebarSettingsButton = (): ReactElement => {
  ...
  const settingsItems: ProfileSectionItemProps[] = [
    { title: 'Ayarlar', href: settingsDefaultPath, icon: SettingsIcon },
    { title: 'Görünüm', href: `${settingsUrl}/appearance`, icon: EyeIcon },
  ];
  ...
  return (
    <>
      <Tooltip side="right" content="Ayarlar">
        <button
          type="button"
          aria-label="Ayarlar"
          aria-expanded={isOpen}
